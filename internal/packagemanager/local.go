...
func (pm *LocalManager) SaveManifest(manifest *LocalManifest) error {
	...
	if err := os.WriteFile(pm.manifestPath, data, 0o644); err != nil {
...
func (pm *LocalManager) Build() error {
	...
	return os.WriteFile(filepath.Join(buildDir, "build-info.json"), buildInfoData, 0o644)
}
...
func (pm *LocalManager) saveLockFile() error {
	...
	return os.WriteFile(pm.lockPath, data, 0o644)
}
