...
type ThrowsSpecification struct {
	ExceptionTypes []*parser.HIRType
	Constraints    []*ThrowsConstraint
...
type ThrowsViolation struct {
	TraitMethod *parser.HIRFunction
	ImplMethod  *parser.HIRFunction
	Expected    *ThrowsSpecification
	Actual      *ThrowsSpecification
	Constraint  *ThrowsConstraint
	Message     string
	Position    position.Position
...
func (imv *ImplThrowsValidator) createViolation(violationType ThrowsViolationType, traitMethod, implMethod *parser.HIRFunction,
	traitSpec, implSpec *ThrowsSpecification, message string,
) error {
	violation := ThrowsViolation{
		Type:        violationType,
...
func (imv *ImplThrowsValidator) checkExceptionTypeCompatibility(traitSpec, implSpec *ThrowsSpecification,
	traitMethod, implMethod *parser.HIRFunction,
) error {
