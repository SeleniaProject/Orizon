...
func buildMinimalHIR() *hir.HIRProgram {
	...
	fn.Body = &hir.HIRBlockStatement{
		ID: 4, Span: position.Span{Start: position.Position{Filename: "main.oriz", Line: 2, Column: 1}, End: position.Position{Filename: "main.oriz", Line: 2, Column: 5}},
