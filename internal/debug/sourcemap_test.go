...
func TestGenerateSourceMap_Minimal(t *testing.T) {
	...
	fn := &hir.HIRFunctionDeclaration{
		...
		Body: &hir.HIRBlockStatement{
			ID: 3, Span: position.Span{Start: position.Position{Filename: "main.oriz", Line: 1, Column: 1}, End: position.Position{Filename: "main.oriz", Line: 3, Column: 1}},
			Statements: []hir.HIRStatement{&hir.HIRExpressionStatement{
				ID: 4, Span: position.Span{Start: position.Position{Filename: "main.oriz", Line: 2, Column: 5}, End: position.Position{Filename: "main.oriz", Line: 2, Column: 10}},
