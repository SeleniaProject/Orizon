...
func pos(file string, line, col, off int) Position { return Position{File: file, Line: line, Column: col, Offset: off} }
func spanAt(file string, line, col int) Span       { return Span{Start: pos(file, line, col, 0), End: pos(file, line, col+1, 1)} }
