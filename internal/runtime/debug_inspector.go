...
type TraceEvent struct {
	...
	// CorrelationID groups related messages across actors for causal tracing.
	CorrelationID string
	// MessageID is the unique identifier of the message event when available.
	MessageID MessageID
}
...
type MessageTracer struct {
	...
	perSize  int
	// perCorrelation stores events keyed by correlation id
