...
- [x] **目的**: 言語自身による実装の設計（docs/self_hosting_design.md）
- **成果物**:
  - [x] 自己参照コンパイラ設計
  - [x] ブートストラップ戦略
  - [x] 段階的移行計画
...
- [x] **目的**: 重要コンポーネントのOrizon実装（計画） docs/self_hosting_partial.md
- **成果物**:
  - [ ] 字句解析器のOrizon実装
  - [ ] 標準ライブラリのOrizon実装
  - [ ] クロスコンパイル確認
  - [x] 補助: ブートストラップスナップショットCLI（MIR/LIR/x64の出力）とゴールデン比較テストの整備（examples/bootstrap_samples, artifacts/selfhost, test/golden/selfhost）
  - [x] 補助: パーサーの誤り回復・Pratt優先順位系の包括テスト整備（自己ホスト前提の堅牢化）
- **依存関係**: 5.2.1
- **推定工数**: 大（40日）

#### 5.2.3 完全Self-Hosting
- [x] **目的**: 完全な自己ホスティングの実現（計画） docs/self_hosting_full.md
- **成果物**:
  - [ ] 完全なOrizonコンパイラ
  - [ ] ビルドシステム統合
  - [ ] 配布システム更新
  - [x] 補助: ブートストラップ再現用ツール/手順の雛形（`cmd/orizon-bootstrap`、Makefile ターゲット、`test/selfhost_bootstrap_test.go`）
- **依存関係**: 5.2.2
- **推定工数**: 大（50日）
...
#### 5.3.1 コミュニティポータル
- [x] **目的**: 開発者コミュニティの形成支援（計画） docs/community_portal.md
- **成果物**:
  - [ ] ドキュメントサイト
  - [ ] チュートリアル作成
  - [ ] フォーラム設置
...
#### 5.3.2 パッケージエコシステム
- [x] **目的**: サードパーティパッケージの育成（計画） docs/package_ecosystem.md
- **成果物**:
  - [ ] パッケージテンプレート
  - [ ] 開発ガイドライン
  - [ ] 品質ガイドライン
...
#### 5.3.3 企業採用支援
- [x] **目的**: エンタープライズ環境での採用促進（計画） docs/enterprise_adoption.md
- **成果物**:
  - [ ] 移行ガイド
  - [ ] サポートシステム
  - [ ] トレーニング資料
...
#### 5.4.1 包括的テストスイート
- [x] **目的**: 全機能の網羅的テスト（戦略） docs/testing_strategy.md
- **成果物**:
  - [ ] 回帰テストスイート
  - [ ] パフォーマンステスト
  - [ ] セキュリティテスト
...
#### 5.4.2 相互運用性テスト
- [x] **目的**: 他言語・システムとの連携検証（計画） docs/interoperability_plan.md
- **成果物**:
  - [ ] C ABI互換性テスト
  - [ ] WebAssembly動作確認
  - [ ] プラットフォーム間テスト
...
#### 5.4.4 リリース準備
- [x] **目的**: 1.0リリースに向けた最終準備（計画） docs/release_preparation.md
- **成果物**:
  - [ ] リリースノート作成
  - [ ] インストーラー作成
  - [ ] 配布チャネル整備
